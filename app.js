...
var TWILIO_PHONE_CALLBACK_URL = 'https://handler.twilio.com/twiml/....';
...
function makeCallsToAll() {
  ...
  rows.forEach(function(row) {
    row[STATUS] = makeCall(row[PHONE_NUMBER],row[SOURCE_NUMBER]);
  });
...
function sendWhatsApp(phoneNumber, message) {
  ...
  var twilioUrl = 'https://api.twilio.com/2010-04-01/Accounts/' + TWILIO_ACCOUNT_SID + '/Messages.json';
  var twilioWhatsAppUrl = 'https://api.twilio.com/2010-04-01/Accounts/' + TWILIO_ACCOUNT_SID + '/Messages.json';
  //https://api.twilio.com/2010-04-01/Accounts/AC3edf5abb365c58c7f75520a6a11b692f/Messages.json
 ...
 */
function makeCall(phoneNumber,source) {
  var out = new Array();
